...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar n = d.getDate();\r\n");
      out.write("\tvar txtdate=document.getElementById(\"booking_date\").value;\r\n");
      out.write("\tvar t=txtdate.split(\"-\");\r\n");
      out.write("\tif(parseInt(t[2])<n)\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\tdocument.getElementById(\"err_date\").innerHTML=\"invalid date\";\r\n");
      out.write("\t\t//alert(\"invalid date\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\telse\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\tdocument.getElementById(\"err_date\").innerHTML=\"\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("   \t\t<h1>What are you looking for?</h1>\r\n");
      out.write("   \t\t<form action=\"book_ticket.jsp\">\r\n");
      out.write("   \t       <div class=\"dropdown-buttons\">   \r\n");
      out.write("            \t\t  <div class=\"dropdown-button\">           \t\t\t\r\n");
      out.write("            \t\t\t<select name=\"mid\" class=\"dropdown\" tabindex=\"9\" data-settings='{\"wrapperClass\":\"flat\"}' required>\r\n");
      out.write("            \t\t\t<option value=\"\">Select Movie</option>\r\n");
      out.write("            \t\t\t ");
    ...
    while(rs1.next())
    {
      ...
      out.write("    \r\n");
      out.write("\t\t\t\t\t  </select>\r\n");
      out.write("\t\t\t\t\t  <input type='date' name=\"booking_date\" id=\"booking_date\" required=\"required\" onblur=\"validateDate()\">\r\n");
      out.write("\t\t\t\t\t  <span id=\"err_date\" style=\"color: red\"></span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t     \r\n");
      out.write("\t\t\t\t   </div>  \r\n");
      out.write("\t\t    \r\n");
      ...
      out.write("\t               <label class=\"btn1 btn-2 btn-2g\"><input type=\"submit\"></label>\r\n");
      out.write("\t            </div>\r\n");
      out.write("\t\t\t</form>        \t\t\r\n");
      ...
      out.write("   \t\t\t ");
 		...
 		ResultSet rs= st.executeQuery("select trailer,video_link from movie_trailer limit 4");
 		while(rs.next())
 		{
