...
public final class movie_005fupdate_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs = st.executeQuery("select id, movie_id, theater_id, start_date, movie_status from movie_theater where movie_status='active'");
while(rs.next())
{
