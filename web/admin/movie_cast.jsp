...
<div id="wrapper">
 	...
 	<div class="grid-form">
 		...
 		<form action="movie_cast_save.jsp">
 		<input type="hidden" name="mid" value="<%=request.getParameter("mid")%>">
  <div class="form-group">
    <label for="exampleInputEmail1">Movie Caste & Crew</label>
    <textarea class="form-control" id="name" name="name" placeholder="Movie Details" required="required"></textarea>
  </div>
