...
<div id="wrapper">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="cost" name="cost" placeholder="Cost" required="required">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="place" name="place" placeholder="Place" required="required">
    <option value=""></option>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="seats" name="seats" placeholder="Seating Capacity" required="required">
  </div>
