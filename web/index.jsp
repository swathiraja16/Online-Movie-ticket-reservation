...
function validateDate()
{
	...
	if(parseInt(t[2])<n)
		{
		document.getElementById("err_date").innerHTML="invalid date";
		//alert("invalid date");
		}
	else
		{
...
<jsp:include page="include/header.jsp"></jsp:include>
   <div class="banner">
   		...
   		<form action="book_ticket.jsp">
   	       <div class="dropdown-buttons">   
            		  <div class="dropdown-button">           			
            			<select name="mid" class="dropdown" tabindex="9" data-settings='{"wrapperClass":"flat"}' required>
    ...
    <%} %>
					  ...
					  <input type='date' name="booking_date" id="booking_date" required="required" onblur="validateDate()">
			    ...
			    <div class="contact_btn">
	               <label class="btn1 btn-2 btn-2g"><input type="submit"></label>
	            </div>
			</form>        		
